...
def generate_lucky_numbers(how_many):
...
def create_fortune_cookie_message(how_many_lucky_numbers):
    ...
    number = generate_lucky_numbers(how_many_lucky_numbers)
    return "{}\n{}".format(fortune, number)
